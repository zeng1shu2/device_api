...
# 全局url地址
url_check = 'https://172.16.33.55:9000/restconf/data/huawei-nat-server:nat-server'
url_create = 'https://172.16.33.55:9000/restconf/data/huawei-nat-server:nat-server/server-mapping=test1,public'
url_add_policy = 'https://172.16.33.55:9000/restconf/data/huawei-security-policy:sec-policy/vsys=public/static-policy' \
                 '/rule= '
...
def create_policy(name, src_zone, dst_zone, src_ip, dst_ip, dst_port):
    ...
    url_add_policy = f'https://172.16.33.55:9000/restconf/data/huawei-security-policy:sec-policy/vsys=public' \
...
def del_policy(name):
    """NG Firewall Del Port Mapping"""
    url_policy_del = f'https://172.16.33.55:9000/restconf/data/huawei-security-policy:sec-policy/vsys=public/static' \
                     f'-policy/rule={name} '
